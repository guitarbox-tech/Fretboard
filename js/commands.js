...
class CommandHistory {
    ...
    add(command) {
        ...
        this.redoStack = [];
        console.log('ADD Cantidad de comandos en la pila undo:', this.undoStack.length);
        console.log('ADD Cantidad de comandos en la pila redo:', this.redoStack.length);
    }
    ...
    undo() {
        if (this.undoStack.length > 0) {
            ...
            console.log('UNDO Cantidad de comandos en la pila redo:', this.redoStack.length);
        }
    }
...
function addRow() {
    ...
    commandHistory.add(addRowCommand); // Agregar el comando a la historia de comandos
}


function deleteRow() {
    deleteRowCommand.execute(); // Ejecutar la acción para agregar una fila
    commandHistory.add(deleteRowCommand); // Agregar el comando a la historia de comandos
}

function changeNote(nuevaFila, nuevaNota, opacidades, visibilidades, indicePrimeraNota, indiceFila) {
    ...
    commandHistory.add(changeNoteCommand); // Agregar el comando a la historia de comandos
}